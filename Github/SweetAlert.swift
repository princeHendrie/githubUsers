...
class SuccessAnimatedView: AnimatableView {
    ...
    func setupLayers() {
        ...
        outlineLayer.strokeColor = bluebuttonColor.cgColor
        //UIColor(red: 150.0/255.0, green: 216.0/255.0, blue: 115.0/255.0, alpha: 1.0).cgColor;
        ...
        circleLayer.fillColor = UIColor.clear.cgColor;
        circleLayer.strokeColor = bluebuttonColor.cgColor
        //UIColor(red: 150.0/255.0, green: 216.0/255.0, blue: 115.0/255.0, alpha: 1.0).cgColor;
        circleLayer.lineCap = CAShapeLayerLineCap.round
        circleLayer.lineWidth = 4;
        circleLayer.actions = [
